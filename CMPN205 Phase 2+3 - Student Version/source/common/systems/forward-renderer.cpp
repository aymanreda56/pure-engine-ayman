    ...
    void ForwardRenderer::render(World* world){
       ...
       glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
        ...
        if(this->skyMaterial){
            ...
            glm::vec3 cameraPostion = camera->getOwner()->localTransform.position;
            ...
            glm::mat4 sphereCenter = glm::translate(model, cameraPostion);
            ...
            //obj.material->shader->set("transform", VP * obj.localToWorld);
            skyMaterial->shader->set("transform", alwaysBehindTransform * VP * sphereCenter );
